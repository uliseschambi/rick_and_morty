  ...
  return (
    <DivContainer>
      <FORM onSubmit={handleSubmit}>
        {errors.username ? <DivError>{errors.username}</DivError> : <DivError visibility="true">hidden</DivError>}
        <label htmlFor="username">
          username:
          <input type="text" name="username" onChange={handleInputChange} value={userData.username}></input>
        </label>
        {errors.password ? <DivError>{errors.password}</DivError> : <DivError visibility="true">hidden</DivError>}
